package com.nounours.book.user;
...
public class User implements UserDetails, Principal { // implements UserDetails and Principal is important for  springsecurity and we need to override and implement their methods
    ...
    @Column(unique = true)
    private String email; // unique identifier of users
    ...
    public String getName() {
        return email; //  unique identifier of users
    }
